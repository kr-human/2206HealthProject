		...
		<form action="updateOk.jsp" method="post" onsubmit="return formCheck();">
			...
			<div class="mb-3 row">
				...
				<div class="col-sm-2">
				  ...
				  <input class="form-check-input" type="radio" name="gender" id="gender1"  value="M" ${memberVO.gender=='M' ? "checked='checked'" : ""} readonly>
				</div>
				<div class="col-sm-2">
			  	  <label for="gender2" class="col-sm-2 col-form-label">여자</label>
				  <input class="form-check-input" type="radio" name="gender" id="gender2" value="F" ${memberVO.gender=='F' ? "checked='checked'" : ""} readonly>
				 </div> 
			</div>
			<div class="mb-3 row">
