...
public interface TrainerDAO {
	// 나의 회원 목록 보기
	List<MemberVO> SelectByUserList(SqlSession sqlSession) throws SQLException;
	// 나의 회원 정보 보기
	MemberVO SelectByUserInfo(SqlSession sqlSession, String myTrainer) throws SQLException;
